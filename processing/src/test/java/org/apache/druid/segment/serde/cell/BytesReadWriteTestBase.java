...
public abstract class BytesReadWriteTestBase implements BytesReadWriteTest
{
  ...
  public void setup()
  {
    ResourceHolder<ByteBuffer> uncompressedBlockHolder1 = NativeClearedByteBufferProvider.INSTANCE.get();
    ResourceHolder<ByteBuffer> uncompressedBlockHolder2 = NativeClearedByteBufferProvider.INSTANCE.get();
