...
public class SerializablePairLongStringComplexMetricSerde extends ComplexMetricSerde
{
  ...
  public void deserializeColumn(ByteBuffer buffer, ColumnBuilder columnBuilder)
  {
    ...
    if (version == 0 || version == 1 || version == 2) {
      ...
      SerializablePairLongStringComplexColumn.Factory factory =
          new SerializablePairLongStringComplexColumn.Factory(buffer, NativeClearedByteBufferProvider.INSTANCE);
      columnBuilder.setComplexColumnSupplier(factory::create);
    }
  }
