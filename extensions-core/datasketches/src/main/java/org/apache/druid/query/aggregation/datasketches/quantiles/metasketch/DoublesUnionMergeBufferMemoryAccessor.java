...
public class DoublesUnionMergeBufferMemoryAccessor implements MemoryAccessor<DoublesUnion>
{
  private final DoublesSketchMergeBufferAggregatorHelper helper;

  public DoublesUnionMergeBufferMemoryAccessor(DoublesSketchMergeBufferAggregatorHelper helper)
  {
    this.helper = helper;
  }
  ...
  @Override
  public DoublesUnion wrap(ByteBuffer byteBuffer, int position)
  {
    DoublesUnion doublesUnion = helper.getSketchAtPosition(
        byteBuffer,
        position
    );
